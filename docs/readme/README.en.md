...
More complete prompt examples are in [../CODEX_PROMPTS.md](../CODEX_PROMPTS.md). Example generated outputs are in [../../examples/outputs](../../examples/outputs).

## Portfolio case study

For a higher-level explanation of the product framing, architecture choices, safety boundaries, and next steps, see [../portfolio-case-study.md](../portfolio-case-study.md).
